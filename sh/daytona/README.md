...
| `DAYTONA_SANDBOX_SIZE` | Spawn preset (`default`, `small`, `medium`, `large`) | `default` |
...
If you leave all sandbox sizing variables unset, Spawn defers to Daytona's platform defaults: 1 vCPU, 1 GiB RAM, and 3 GiB disk.
