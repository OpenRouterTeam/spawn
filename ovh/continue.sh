...
# 10. Start Continue CLI in TUI mode
log_warn "Starting Continue CLI in TUI mode..."
sleep 1
clear
interactive_session "${OVH_SERVER_IP}" "source ~/.zshrc && cn"
